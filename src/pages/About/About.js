      ...
      <h2 className="text-left font-weight-bold md-5">Our Latest News</h2>
        <Row className="process">
          ...
          <div className="img4">
            ...
            <div md="6">
              <p >
                <FontAwesomeIcon icon={faCalendar} color="#f9575c"/> <span className="mr-8">23 Jan 2020</span>
              </p>
            </div>
            <div md="6">
              <p>
                <FontAwesomeIcon icon={faCommentDots} color="#f9575c"/> <span className="mr-8">551</span>
              </p>
            </div>
            </div>
          </Col>
